define(["page", "templates", "route", "state"], function(
  page,
  templates,
  route,
  state
  ...
  function homeRender(url, query) {
    ...
    var $def = $.Deferred(),
      ...
      view = {
        wellicon:
          '<img src="/theme/images/well.png" class="tinyicon" title="old well icon" alt=" "/>',
        gearicon:
          '<img src="/theme/images/settings.png" class="tinyicon" title="gear icon" alt=" "/>',
        Flickr: '<a class="onlineOnly" href="https://flickr.com">Flickr</a>',
